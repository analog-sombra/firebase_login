...
class SignupPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    ValueNotifier<bool> isShowPassOne = useState(false);
    ValueNotifier<bool> isShowPassTwo = useState(false);
                        ...
                        Padding(
                          ...
                          child: ClipRRect(
                            ...
                            child: TextFormField(
                              ...
                              obscureText: !isShowPassOne.value,
                              style: const TextStyle(color: Colors.white),
                              decoration: InputDecoration(
                                suffixIcon: InkWell(
                                  onTap: () {
                                    isShowPassOne.value = !isShowPassOne.value;
                                  },
                                  child: Icon(
                                    isShowPassOne.value
                        ...
                        Padding(
                          ...
                          child: ClipRRect(
                            ...
                            child: TextFormField(
                              ...
                              obscureText: !isShowPassTwo.value,
                              validator: (value) {
                                if (value == null ||
                                    value == "" ||
                                    value.isEmpty) {
                              ...
                              decoration: InputDecoration(
                                suffixIcon: InkWell(
                                  onTap: () {
                                    isShowPassTwo.value = !isShowPassTwo.value;
                                  },
                                  child: Icon(
                                    isShowPassTwo.value
                                        ? Icons.visibility_outlined
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (formKey.currentState!.validate()) {
                                    await ref.watch(appAuthState).register(
